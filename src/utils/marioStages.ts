...
export const STAGE_DATA: MarioStage[] = [
  ...
  // ==========================================
  {
    ...
    platforms: [
      ...
      // Floating blocks
      { x: 250, y: 320 - 95, width: 32, height: 24, type: 'question' },
      ...
      { x: 804, y: 320 - 170, width: 32, height: 24, type: 'question' },

      { x: 1450, y: 320 - 105, width: 32, height: 24, type: 'question' },
      { x: 1482, y: 320 - 105, width: 32, height: 24, type: 'brick' },
      { x: 1514, y: 320 - 105, width: 32, height: 24, type: 'question' },
  ...
  // ==========================================
  {
    ...
    platforms: [
      ...
      { x: 360, y: 220, width: 32, height: 20, type: 'question' },
      ...
      { x: 1276, y: 210, width: 32, height: 24, type: 'question' },

      { x: 2000, y: 190, width: 128, height: 22, type: 'brick' },
      { x: 2048, y: 130, width: 32, height: 24, type: 'question' },
  ...
  // ==========================================
  {
    ...
    platforms: [
      ...
      { x: 414, y: 150, width: 32, height: 24, type: 'question' },
      ...
      { x: 1664, y: 130, width: 32, height: 24, type: 'question' },

      { x: 2250, y: 180, width: 160, height: 24, type: 'brick' },
      { x: 2314, y: 120, width: 32, height: 24, type: 'question' },
